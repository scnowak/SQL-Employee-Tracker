          ...
          inquirer
            ...
            .then((answer) => {
              ...
              db.query(
                ...
                function (err, resuolts) {
                  console.log(
                    newDepartment + " has been added to the department table"
                  );
                  if (err) throw err;
            ...
            .then((answer) => {
              ...
              db.query(
                ...
                function (err, results) {
                  console.log(
                    newRole + " has been added to the new role table"
                  );
                  if (err) throw err;
            ...
            .then((answer) => {
              ...
              db.query(sql, [newRoleId, employeeId], (err, result) => {
                if (err) {
                  ...
                  console.log(
                    `Employee with ID ${employeeId} has been updated to the new role.`
                  );
                }
